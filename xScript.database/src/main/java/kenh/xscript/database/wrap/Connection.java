...
package kenh.xscript.database.wrap;
...
/**
 * 
 * The wrapper class of java.sql.Connection, to implement Callback interface.
 * 
 * @author Kenneth
 * @version 1.0
 *
 */
public class Connection implements java.sql.Connection, Callback {
