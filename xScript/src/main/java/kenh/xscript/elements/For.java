...
public class For extends NormalElement {
	...
	private static final String VARIABLE_INDEX = "___index___";
	private static final String VARIABLE_REF = "___ref___";
	private static final String VARIABLE_LOOP_lIMIT = "___loop_limit___";
	...
	public int process(@Attribute(ATTRIBUTE_REF) Object ref, @Attribute(ATTRIBUTE_SUBREF) String subRef, @Attribute(ATTRIBUTE_SKIP) int skip) throws UnsupportedScriptException {
		...
		try {
			...
			for(Object sub: iterable) {
				...
				if(!this.getEnvironment().containsVariable(VARIABLE_LOOP_lIMIT) && i > MAX_LOOP) {
