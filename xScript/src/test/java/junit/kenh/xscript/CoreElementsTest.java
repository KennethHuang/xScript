...
public class CoreElementsTest {
	...
	public void testScript_logic2() throws Throwable {
		...
		Assert.assertEquals("demo", e.getEnvironment().getVariable("___xScript___"));
		Assert.assertEquals(System.getProperty("user.dir"), e.getEnvironment().getVariable("___home___"));
	...
	public void testFor_logic1() throws Throwable {
		String content = 
			...
			"			<set var=\"global1_index\" value=\"{{global1_index} + {___index___}}\"/>" +
			"		</for>" +
			"		<for from=\"10\" to=\"2\">" +
			"			<set var=\"global2\" value=\"{{global2} + 1}\"/>" +
			"			<set var=\"global2_index\" value=\"{{global2_index} + {___index___}}\"/>" +
			"		</for>" +
			"		<for from=\"2\" to=\"7\" step=\"2\">" +
			"			<set var=\"global3\" value=\"{{global3} + 1}\"/>" +
			"			<set var=\"global3_index\" value=\"{{global3_index} + {___index___}}\"/>" +
			"		</for>" +
			"		<for from=\"1\" to=\"10\">" +
			"			<ifthen cond=\"{___index___} mod 2 == 1\">" +
			"				<continue/>" +
			"			</ifthen>" +
			"			<set var=\"global4\" value=\"{{global4} + 1}\"/>" +
			"			<set var=\"global4_index\" value=\"{{global4_index} + {___index___}}\"/>" +
			"		</for>" +
			"		<for from=\"1\" to=\"10\">" +
			...
			"			<set var=\"global5_index\" value=\"{{global5_index} + {___index___}}\"/>" +
			"		</for>" +
			"	</method>" +
			"</script>";
	...
	public void testClear_logic1() throws Throwable {
		String content = 
			"<script>" +
			"	<set var=\"_global_\" value=\"1\"/>" +
			"	<method name=\"main\">" +
			"		<set var=\"public global1\" value=\"{_global_}\"/>" +
			"		<clear var=\"_global_\"/>" +
			"		<set var=\"public global2\" value=\"{_global_}\"/>" +
			"	</method>" +
			"</script>";
	...
	public void testInclude_error1() throws Throwable {
		...
		String content = 
			...
			"	<include file=\"" + url + "\"/>" +
			"	<method name=\"main\">" +
			"		<set var=\"public _global_\" value=\"{name}\"/>" +
			"	</method>" +
			"</script>";
	...
	public void testCatch_logic1() throws Throwable {
		String content = 
				...
				"		</if>" +
				"		<catch>" +
				"			<set var=\"public var8\" value=\"{___exception___.getMessage()}\"/>" +
				"		</catch>" +
				"		<for from=\"9\" to=\"11\">" +
				"			<set var=\"public var{___index___}\" value=\"{___index___}\"/>" +
				"			<demo:exception/>" +
				"		</for>" +
				"		<catch>" +
				"		</catch>" +
